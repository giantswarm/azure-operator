...
func (r Resource) newMainDeployment(cluster azuretpr.CustomObject) (Deployment, error) {
	...
	params := map[string]interface{}{
		...
		"hostedZones":                     cluster.Spec.Azure.HostedZones,
		"kubernetesAPISecurePort":         cluster.Spec.Cluster.Kubernetes.API.SecurePort,
		"etcdPort":                        cluster.Spec.Cluster.Etcd.Port,
		"etcdDomain":                      cluster.Spec.Cluster.Etcd.Domain,
		"kubernetesAPIDomain":             cluster.Spec.Cluster.Kubernetes.API.Domain,
		"kubernetesIngressWildcardDomain": cluster.Spec.Cluster.Kubernetes.IngressController.WildcardDomain,
