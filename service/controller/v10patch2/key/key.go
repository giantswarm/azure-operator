...
import (
	...
	"github.com/giantswarm/azure-operator/service/controller/v10patch2/templates/ignition"
...
//
// service/controller/v10patch2/resource/<resource>/template/<template>
//
...
func ARMTemplateURI(version, resource, template string) string {
	return fmt.Sprintf("https://raw.githubusercontent.com/giantswarm/azure-operator/%s/service/controller/v10patch2/resource/%s/template/%s", version, resource, template)
}
