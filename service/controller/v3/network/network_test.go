...
func TestComputeSubnets(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			"10.0.0.0/16",
			Subnets{
				Calico: net.IPNet{net.IPv4(10, 0, 3, 0), net.IPv4Mask(255, 255, 255, 224)},
				Master: net.IPNet{net.IPv4(10, 0, 0, 0), net.IPv4Mask(255, 255, 255, 0)},
				Parent: net.IPNet{net.IPv4(10, 0, 0, 0), net.IPv4Mask(255, 255, 0, 0)},
				VPN:    net.IPNet{net.IPv4(10, 0, 2, 0), net.IPv4Mask(255, 255, 255, 0)},
				Worker: net.IPNet{net.IPv4(10, 0, 1, 0), net.IPv4Mask(255, 255, 255, 0)},
			},
			nil,
		},
		{
