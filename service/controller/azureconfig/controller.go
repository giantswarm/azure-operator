...
import (
	...
	"github.com/giantswarm/azure-operator/v8/pkg/handler/ipam"
	"github.com/giantswarm/azure-operator/v8/pkg/handler/nodes"
	"github.com/giantswarm/azure-operator/v8/pkg/handler/release"
	...
	"github.com/giantswarm/azure-operator/v8/service/controller/azureconfig/handler/azureconfigfinalizer"
	"github.com/giantswarm/azure-operator/v8/service/controller/azureconfig/handler/blobobject"
	"github.com/giantswarm/azure-operator/v8/service/controller/azureconfig/handler/capzcrs"
	"github.com/giantswarm/azure-operator/v8/service/controller/azureconfig/handler/clusterid"
	"github.com/giantswarm/azure-operator/v8/service/controller/azureconfig/handler/containerurl"
	"github.com/giantswarm/azure-operator/v8/service/controller/azureconfig/handler/deployment"
	"github.com/giantswarm/azure-operator/v8/service/controller/azureconfig/handler/dnsrecord"
	"github.com/giantswarm/azure-operator/v8/service/controller/azureconfig/handler/encryptionkey"
	"github.com/giantswarm/azure-operator/v8/service/controller/azureconfig/handler/endpoints"
	"github.com/giantswarm/azure-operator/v8/service/controller/azureconfig/handler/masters"
	"github.com/giantswarm/azure-operator/v8/service/controller/azureconfig/handler/namespace"
	"github.com/giantswarm/azure-operator/v8/service/controller/azureconfig/handler/resourcegroup"
	"github.com/giantswarm/azure-operator/v8/service/controller/azureconfig/handler/service"
	"github.com/giantswarm/azure-operator/v8/service/controller/azureconfig/handler/storageclassmigrator"
	"github.com/giantswarm/azure-operator/v8/service/controller/azureconfig/handler/vnetpeering"
	"github.com/giantswarm/azure-operator/v8/service/controller/azureconfig/handler/workermigration"
