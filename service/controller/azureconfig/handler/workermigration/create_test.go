	...
	for i, s := range masterUpgradePendingStatuses {
		t.Run(strconv.Itoa(i), func(t *testing.T) {
			...
			r := &Resource{
				...
				wrapAzureAPI: func(cf *azureclient.Factory, azureCluster *capzv1alpha3.AzureCluster) azure.API { return nil },
			}
...
func TestMigrationCreatesMachinePoolCRs(t *testing.T) {
	...
	r := &Resource{
		ctrlClient:   ctrlClient,
		logger:       microloggertest.New(),
		wrapAzureAPI: func(cf *azureclient.Factory, azureCluster *capzv1alpha3.AzureCluster) azure.API { return m },
	}
...
func TestMigrationCreatesDrainerConfigCRs(t *testing.T) {
	...
	r := &Resource{
		...
		wrapAzureAPI: func(cf *azureclient.Factory, azureCluster *capzv1alpha3.AzureCluster) azure.API {
			return mockAzureAPI
		},
	}
