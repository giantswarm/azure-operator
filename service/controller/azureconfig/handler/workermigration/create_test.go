	...
	for i, s := range masterUpgradePendingStatuses {
		t.Run(strconv.Itoa(i), func(t *testing.T) {
			...
			r := &Resource{
				...
				wrapAzureAPI: func(cf credentialsaware.Factory, clusterID string) azure.API { return nil },
			}
...
func TestMigrationCreatesMachinePoolCRs(t *testing.T) {
	...
	r := &Resource{
		ctrlClient:   ctrlClient,
		logger:       microloggertest.New(),
		wrapAzureAPI: func(cf credentialsaware.Factory, clusterID string) azure.API { return m },
	}
