...
import (
	...
	"github.com/giantswarm/azure-operator/v5/service/controller/azureconfig/workermigration/internal/azure"
	"github.com/giantswarm/azure-operator/v5/service/controller/azureconfig/workermigration/internal/mock_azure"
...
func TestFinishedMigration(t *testing.T) {
	...
	ensureCRsExist(t, fakeClient, []string{
		"cluster.yaml",
		"azureconfig.yaml",
		"azurecluster.yaml",
	})
