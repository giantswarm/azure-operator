...
func Test_TemplateURI(t *testing.T) {
	...
	euri := "https://raw.githubusercontent.com/giantswarm/azure-operator/dev/service/controller/v5/arm_templates/worker.json"
...
func Test_BaseTemplateURI(t *testing.T) {
	...
	euri := "https://raw.githubusercontent.com/giantswarm/azure-operator/master/service/controller/v5/arm_templates/"
