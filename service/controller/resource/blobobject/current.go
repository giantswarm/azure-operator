...
func (r *Resource) GetCurrentState(ctx context.Context, obj interface{}) (interface{}, error) {
	...
	if cc.ContainerURL == nil {
		r.logger.LogCtx(ctx, "level", "debug", "message", "containerurl resource is not ready") // nolint: errcheck
	...
	r.logger.LogCtx(ctx, "level", "debug", "message", "finding blob object's container") // nolint: errcheck
	...
	if !containerExists {
		r.logger.LogCtx(ctx, "level", "debug", "message", "did not find blob object's container") // nolint: errcheck
		resourcecanceledcontext.SetCanceled(ctx)
		r.logger.LogCtx(ctx, "level", "debug", "message", "canceling resource") // nolint: errcheck
		return nil, nil
	} else if err != nil {
	...
	r.logger.LogCtx(ctx, "level", "debug", "message", "found blob object's container") // nolint: errcheck

	r.logger.LogCtx(ctx, "level", "debug", "message", "finding container objects") // nolint: errcheck
	...
	r.logger.LogCtx(ctx, "level", "debug", "message", "found container objects") // nolint: errcheck
