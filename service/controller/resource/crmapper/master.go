...
func (r *Resource) getMasters(ctx context.Context, cluster capiv1alpha3.Cluster, azureCluster capzv1alpha3.AzureCluster) ([]providerv1alpha1.AzureConfigSpecAzureNode, error) {
	...
	var masters []providerv1alpha1.AzureConfigSpecAzureNode
