...
import (
	...
	"github.com/giantswarm/azure-operator/v5/service/controller/azuremachinepool/azuremachinepoolconditions"
	"github.com/giantswarm/azure-operator/v5/service/controller/azuremachinepool/cloudconfigblob"
	"github.com/giantswarm/azure-operator/v5/service/controller/azuremachinepool/ipam"
	"github.com/giantswarm/azure-operator/v5/service/controller/azuremachinepool/nodepool"
	"github.com/giantswarm/azure-operator/v5/service/controller/azuremachinepool/spark"
...
func NewController(config ControllerConfig) (*operatorkitcontroller.Controller, error) {
	...
	if config.CPAzureClientSet == nil {
		return nil, microerror.Maskf(controller.InvalidConfigError, "%T.CPAzureClientSet must not be empty", config)
	}
