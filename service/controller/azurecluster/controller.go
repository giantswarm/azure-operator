...
import (
	...
	"github.com/giantswarm/azure-operator/v5/service/controller/azurecluster/azureclusterconditions"
	"github.com/giantswarm/azure-operator/v5/service/controller/azurecluster/azureclusterconfig"
	"github.com/giantswarm/azure-operator/v5/service/controller/azurecluster/azureclusterupgrade"
	"github.com/giantswarm/azure-operator/v5/service/controller/azurecluster/azureconfig"
	"github.com/giantswarm/azure-operator/v5/service/controller/azurecluster/subnet"
...
func NewController(config ControllerConfig) (*controller.Controller, error) {
	...
	{
		resources, err = newAzureClusterResources(config)
		if err != nil {
...
func newAzureClusterResources(config ControllerConfig) ([]resource.Interface, error) {
	var err error
