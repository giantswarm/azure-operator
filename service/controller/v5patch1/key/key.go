...
import (
	...
	"github.com/giantswarm/azure-operator/service/controller/v5patch1/templates/ignition"
...
//
// service/controller/v5patch1/resource/<resource>/template/<template>
//
...
func ARMTemplateURI(version, resource, template string) string {
	return fmt.Sprintf("https://raw.githubusercontent.com/giantswarm/azure-operator/%s/service/controller/v5patch1/resource/%s/template/%s", version, resource, template)
}
