...
func (c CloudConfig) NewMasterCloudConfig(customObject providerv2alpha1.AzureConfig) (string, error) {
...
// base64 encoded string.
func (c CloudConfig) NewWorkerCloudConfig(customObject providerv2alpha1.AzureConfig) (string, error) {
	params := k8scloudconfig.Params{
		Cluster: customObject.Spec.Cluster,
		Hyperkube: k8scloudconfig.Hyperkube{
			Kubelet: k8scloudconfig.HyperkubeKubelet{
...
func (c CloudConfig) getEncryptionkey(customObject providerv2alpha1.AzureConfig) (string, error) {
