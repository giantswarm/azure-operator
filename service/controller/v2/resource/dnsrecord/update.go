...
func (r *Resource) applyUpdateChange(ctx context.Context, obj providerv2alpha1.AzureConfig, change dnsRecords) error {
...
func (r *Resource) newUpdatePatch(ctx context.Context, obj providerv2alpha1.AzureConfig, currentState, desiredState dnsRecords) (*controller.Patch, error) {
...
func (r *Resource) newUpdateChange(ctx context.Context, obj providerv2alpha1.AzureConfig, currentState, desiredState dnsRecords) (dnsRecords, error) {
