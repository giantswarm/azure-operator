...
func (r *Resource) applyDeleteChange(ctx context.Context, obj providerv2alpha1.AzureConfig, change dnsRecords) error {
...
func (r *Resource) newDeletePatch(ctx context.Context, obj providerv2alpha1.AzureConfig, currentState, desiredState dnsRecords) (*controller.Patch, error) {
...
func (r *Resource) newDeleteChange(ctx context.Context, obj providerv2alpha1.AzureConfig, currentState, desiredState dnsRecords) (dnsRecords, error) {
