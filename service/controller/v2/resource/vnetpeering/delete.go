...
func (r Resource) newDeletePatch(ctx context.Context, azureConfig providerv2alpha1.AzureConfig, current, desired network.VirtualNetworkPeering) (*controller.Patch, error) {
...
func (r Resource) applyDeleteChange(ctx context.Context, azureConfig providerv2alpha1.AzureConfig, change network.VirtualNetworkPeering) error {
