...
func (r Resource) newUpdatePatch(ctx context.Context, azureConfig providerv2alpha1.AzureConfig, current, desired network.VirtualNetworkPeering) (*controller.Patch, error) {
...
func (r Resource) newUpdateChange(ctx context.Context, azureConfig providerv2alpha1.AzureConfig, current, desired network.VirtualNetworkPeering) (network.VirtualNetworkPeering, error) {
...
func (r *Resource) applyUpdateChange(ctx context.Context, azureConfig providerv2alpha1.AzureConfig, change network.VirtualNetworkPeering) error {
