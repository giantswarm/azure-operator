...
require (
	...
	github.com/giantswarm/apiextensions v0.3.2-0.20200422115407-9920a84edea1
...
replace (
	...
	github.com/giantswarm/apiextensions => github.com/giantswarm/apiextensions v0.3.2-0.20200422115407-9920a84edea1
