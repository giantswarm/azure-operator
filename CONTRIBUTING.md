...
azure-operator is Apache 2.0 licensed and accepts contributions via GitHub pull requests. This document outlines some of the conventions on commit message formatting, contact points for developers and other resources to make getting your contribution into azure-operator easier.
...
- Isolated. Please try to isolate and reproduce the bug with minimum dependencies. It would significantly slow down the speed to fix a bug if too many dependencies are involved in a bug report. Debugging external systems that rely on azure-operator is out of scope, but we are happy to point you in the right direction or help you interact with azure-operator in the correct manner.
...
- Submit a pull request to giantswarm/azure-operator.
